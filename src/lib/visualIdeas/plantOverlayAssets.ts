...
const ASSETS: Record<string, OverlayAsset> = {
  ...
  cyclamen: {
    key: 'cyclamen',
    src: '/plant-overlays/cyclamen.png',
    defaultWidthFraction: widthFraction(200),
    aspect: 1,
  },
  dogwood: {
  ...
  acorus: {
    key: 'acorus',
    src: '/plant-overlays/acorus.png',
    defaultWidthFraction: widthFraction(220),
    aspect: 1,
  },
  ajuga: {
    key: 'ajuga',
    src: '/plant-overlays/ajuga.png',
    defaultWidthFraction: widthFraction(200),
    aspect: 1,
  },
  alstroemeria: {
    key: 'alstroemeria',
    src: '/plant-overlays/alstroemeria.png',
    defaultWidthFraction: widthFraction(220),
    aspect: 1,
  },
  apodasmia: {
    key: 'apodasmia',
    src: '/plant-overlays/apodasmia.png',
    defaultWidthFraction: widthFraction(220),
    aspect: 1,
  },
  astilbe: {
    key: 'astilbe',
    src: '/plant-overlays/astilbe.png',
    defaultWidthFraction: widthFraction(220),
    aspect: 1,
  },
  azalea: {
    key: 'azalea',
    src: '/plant-overlays/azalea.png',
    defaultWidthFraction: widthFraction(240),
    aspect: 1,
  },
  carex: {
    key: 'carex',
    src: '/plant-overlays/carex.png',
    defaultWidthFraction: widthFraction(200),
    aspect: 1,
  },
  choisya: {
    key: 'choisya',
    src: '/plant-overlays/choisya.png',
    defaultWidthFraction: widthFraction(240),
    aspect: 1,
  },
  'clumping-bamboo': {
    key: 'clumping-bamboo',
    src: '/plant-overlays/clumping-bamboo.png',
    defaultWidthFraction: widthFraction(280),
    aspect: 1,
  },
  'apple-tree': {
  ...
  'photinia-hedge': {
    key: 'photinia-hedge',
    src: '/plant-overlays/photinia-hedge.png',
    defaultWidthFraction: widthFraction(340),
    aspect: 1,
  },
  'loropetalum-hedge': {
    key: 'loropetalum-hedge',
    src: '/plant-overlays/loropetalum-hedge.png',
    defaultWidthFraction: widthFraction(340),
    aspect: 1,
  },
  'teucrium-hedge': {
    key: 'teucrium-hedge',
    src: '/plant-overlays/teucrium-hedge.png',
    defaultWidthFraction: widthFraction(340),
    aspect: 1,
  },
  'titoki-hedge': {
  ...
  heuchera: {
    key: 'heuchera',
    src: '/plant-overlays/heuchera.png',
    defaultWidthFraction: widthFraction(200),
    aspect: 1,
  },
  hosta: {
    key: 'hosta',
    src: '/plant-overlays/hosta.png',
    defaultWidthFraction: widthFraction(220),
    aspect: 1,
  },
  hellebore: {
  ...
  jasmine: {
    key: 'jasmine',
    src: '/plant-overlays/jasmine.png',
    defaultWidthFraction: widthFraction(260),
    aspect: 1,
  },
  kahikatea: {
  ...
  grevillea: {
    key: 'grevillea',
    src: '/plant-overlays/grevillea.png',
    defaultWidthFraction: widthFraction(260),
    aspect: 1,
  },
  lancewood: {
  ...
  leptinella: {
    key: 'leptinella',
    src: '/plant-overlays/leptinella.png',
    defaultWidthFraction: widthFraction(180),
    aspect: 1,
  },
  leucadendron: {
    key: 'leucadendron',
    src: '/plant-overlays/leucadendron.png',
    defaultWidthFraction: widthFraction(280),
    aspect: 1,
  },
  leucospermum: {
    key: 'leucospermum',
    src: '/plant-overlays/leucospermum.png',
    defaultWidthFraction: widthFraction(260),
    aspect: 1,
  },
  libertia: {
    key: 'libertia',
    src: '/plant-overlays/libertia.png',
    defaultWidthFraction: widthFraction(220),
    aspect: 1,
  },
  ligustrum: {
  ...
  'potato-vine': {
    key: 'potato-vine',
    src: '/plant-overlays/potato-vine.png',
    defaultWidthFraction: widthFraction(260),
    aspect: 1,
  },
  puka: {
    key: 'puka',
    src: '/plant-overlays/puka.png',
    defaultWidthFraction: widthFraction(320),
    aspect: 1,
  },
  'port-wine-magnolia': {
  ...
  scleranthus: {
    key: 'scleranthus',
    src: '/plant-overlays/scleranthus.png',
    defaultWidthFraction: widthFraction(180),
    aspect: 1,
  },
  teucrium: {
    key: 'teucrium',
    src: '/plant-overlays/teucrium.png',
    defaultWidthFraction: widthFraction(220),
    aspect: 1,
  },
  rhododendron: {
...
export const CREATE_VISUAL_PLANT_OPTIONS: CreateVisualPlantOption[] = [
  ...
  {
    name: 'Acorus',
    description: 'Strappy grass-like clump for damp edges and pond margins.',
    notes: 'Low maintenance filler; suits moist part-shade borders.',
    detectedIntent: 'groundcover planting',
    style: 'Groundcovers',
    gardenStyles: ['Low maintenance'],
    plantTypes: ['Grass / strappy plant', 'Groundcover'],
    styleTags: ['Low Maintenance'],
    roleTags: ['Filler / Mass Planting', 'Groundcover'],
    conditions: {
      sun: ['full sun', 'part shade'],
      moisture: ['moist'],
      drainage: ['average', 'well drained'],
  ...
  {
    name: 'Ajuga',
    description: 'Spreading groundcover with glossy leaves and blue flower spikes.',
    notes: 'Fast cover for shady gaps and underplanting.',
    detectedIntent: 'groundcover planting',
    style: 'Groundcovers',
    gardenStyles: ['Cottage', 'Low maintenance'],
    plantTypes: ['Groundcover'],
    styleTags: ['Cottage', 'Low Maintenance'],
    roleTags: ['Groundcover', 'Flowering Colour'],
    conditions: {
      sun: ['part shade', 'full shade'],
      moisture: ['average', 'moist'],
      drainage: ['average', 'well drained'],
  ...
  {
    name: 'Alstroemeria',
    description: 'Perennial with colourful lily-like flowers through summer.',
    notes: 'Good cottage border colour; clump-forming.',
    detectedIntent: 'general planting',
    style: 'Border planting',
    gardenStyles: ['Cottage'],
    plantTypes: ['Shrub'],
    styleTags: ['Cottage'],
    roleTags: ['Flowering Colour', 'Filler / Mass Planting'],
    conditions: {
      sun: ['full sun', 'part shade'],
      moisture: ['average', 'moist'],
      drainage: ['well drained'],
  ...
  {
    name: 'Apodasmia',
    description: 'NZ native rush-like clump for wet and coastal planting.',
    notes: 'Tough native filler for damp or coastal edges.',
    detectedIntent: 'general planting',
    style: 'Border planting',
    gardenStyles: ['Native', 'Coastal', 'Low maintenance'],
    plantTypes: ['Grass / strappy plant'],
    styleTags: ['Native', 'Coastal', 'Low Maintenance'],
    roleTags: ['Filler / Mass Planting'],
    conditions: {
      sun: ['full sun', 'part shade'],
      moisture: ['moist'],
      drainage: ['average', 'well drained'],
  ...
  {
    name: 'Astilbe',
    description: 'Shade-loving perennial with feathery plumes of flowers.',
    notes: 'Suits moist shady borders and woodland planting.',
    detectedIntent: 'general planting',
    style: 'Border planting',
    gardenStyles: ['Cottage'],
  ...
  {
    name: 'Azalea',
    description: 'Compact flowering shrub with bold spring colour.',
    notes: 'Acid-loving feature shrub; suits formal and cottage schemes.',
    detectedIntent: 'shrub planting',
    style: 'Shrubs',
    gardenStyles: ['Cottage', 'Formal'],
    plantTypes: ['Shrub'],
    styleTags: ['Cottage', 'Formal'],
    roleTags: ['Flowering Colour', 'Feature Plant'],
    conditions: {
      sun: ['part shade'],
      moisture: ['moist'],
      drainage: ['well drained'],
  ...
  {
    name: 'Carex',
    description: 'Arching grass-like sedge for borders and mass planting.',
    notes: 'Native-friendly low-care filler; many forms available.',
    detectedIntent: 'groundcover planting',
    style: 'Groundcovers',
    gardenStyles: ['Native', 'Low maintenance'],
    plantTypes: ['Grass / strappy plant', 'Groundcover'],
    styleTags: ['Native', 'Low Maintenance'],
    roleTags: ['Filler / Mass Planting', 'Groundcover'],
    conditions: {
      sun: ['full sun', 'part shade'],
      moisture: ['average', 'moist'],
  ...
  {
    name: 'Choisya',
    description: 'Evergreen shrub with glossy leaves and creamy citrus-scented flowers.',
    notes: 'Reprocessed overlay with warmer creamy-yellow blooms; formal or low-care filler.',
    detectedIntent: 'shrub planting',
    style: 'Shrubs',
    gardenStyles: ['Formal', 'Low maintenance'],
    plantTypes: ['Shrub'],
    styleTags: ['Formal', 'Low Maintenance'],
    roleTags: ['Flowering Colour', 'Filler / Mass Planting'],
    conditions: {
      sun: ['full sun', 'part shade'],
      moisture: ['average', 'dry'],
  ...
  },
  {
    ...
    description: 'Non-invasive bamboo clump for screening and tropical structure.',
    notes: 'Upright clumping form; privacy screen or feature plant.',
    detectedIntent: 'hedge/screening',
    style: 'Hedges',
    gardenStyles: ['Subtropical'],
    plantTypes: ['Grass / strappy plant', 'Hedge / screening'],
    styleTags: ['Tropical / Subtropical', 'Privacy / Screening'],
    roleTags: ['Hedge / Screen', 'Feature Plant'],
    conditions: {
      sun: ['full sun', 'part shade'],
      moisture: ['average', 'moist'],
      drainage: ['average', 'well drained'],
  ...
  {
    name: 'Cyclamen',
    description: 'Compact shade-loving plant with colourful winter flowers.',
    notes: 'Suits shady borders and underplanting; cyclamen.png overlay.',
    detectedIntent: 'groundcover planting',
    style: 'Groundcovers',
    gardenStyles: ['Cottage'],
    plantTypes: ['Groundcover'],
    styleTags: ['Cottage'],
    roleTags: ['Flowering Colour', 'Groundcover'],
    conditions: {
      sun: ['part shade', 'full shade'],
      moisture: ['average', 'moist'],
      drainage: ['well drained'],
  ...
  {
    name: 'Daphne',
    description: 'Evergreen or semi-evergreen shrub with intensely fragrant winter flowers.',
    notes: 'Feature shrub for sheltered cottage and formal planting.',
    detectedIntent: 'shrub planting',
    style: 'Shrubs',
    gardenStyles: ['Cottage', 'Formal'],
    plantTypes: ['Shrub'],
  ...
  {
    name: 'Heuchera',
    description: 'Low mounding perennial prized for colourful foliage.',
    notes: 'Cottage border filler; many leaf colours available.',
    detectedIntent: 'groundcover planting',
    style: 'Groundcovers',
    gardenStyles: ['Cottage', 'Low maintenance'],
    plantTypes: ['Groundcover'],
  ...
  {
    name: 'Hosta',
    description: 'Shade-loving clump with bold leaves in many sizes and colours.',
    notes: 'Classic shady border filler; hosta.png overlay.',
    detectedIntent: 'groundcover planting',
    style: 'Groundcovers',
    gardenStyles: ['Cottage'],
    plantTypes: ['Groundcover'],
  ...
  {
    name: 'Jasmine',
    description: 'Evergreen or semi-evergreen climber with light pink fragrant flowers.',
    notes: 'Revised jasmine.png overlay with soft pink blooms — distinct from Star Jasmine (star-jasmine.png).',
    detectedIntent: 'climber planting',
    style: 'Climbers',
    gardenStyles: ['Cottage'],
    plantTypes: ['Climber'],
    styleTags: ['Cottage'],
    roleTags: ['Climber', 'Flowering Colour'],
    conditions: {
      sun: ['full sun', 'part shade'],
      moisture: ['average', 'moist'],
      drainage: ['well drained'],
  ...
  {
    name: 'Grevillea',
    description: 'Australian native shrub or small tree with spider or brush flowers.',
    notes: 'Coastal and dry-tolerant feature; many forms and flower colours.',
    detectedIntent: 'shrub planting',
    style: 'Shrubs',
    gardenStyles: ['Native', 'Coastal', 'Low maintenance'],
    plantTypes: ['Shrub', 'Tree'],
  ...
  {
    name: 'Leptinella',
    description: 'Low NZ native groundcover with ferny foliage and button flowers.',
    notes: 'Tough native mat for paths, gaps, and dry shade.',
    detectedIntent: 'groundcover planting',
    style: 'Groundcovers',
    gardenStyles: ['Native', 'Low maintenance'],
    plantTypes: ['Groundcover'],
    styleTags: ['Native', 'Low Maintenance'],
    roleTags: ['Groundcover'],
    conditions: {
      sun: ['part shade', 'full shade'],
      moisture: ['average', 'dry'],
      drainage: ['average', 'well drained'],
  ...
  {
    name: 'Leucadendron',
    description: 'Protea-family shrub with colourful bracts and fine foliage.',
    notes: 'Coastal feature shrub; distinctive foliage colour through the year.',
    detectedIntent: 'shrub planting',
    style: 'Shrubs',
    gardenStyles: ['Coastal', 'Low maintenance'],
    plantTypes: ['Shrub'],
    styleTags: ['Coastal', 'Low Maintenance'],
    roleTags: ['Feature Plant'],
    conditions: {
      sun: ['full sun'],
      moisture: ['average', 'dry'],
  ...
  {
    name: 'Leucospermum',
    description: 'Coastal protea shrub with bold pincushion flowers.',
    notes: 'Sunny dry site feature; suits coastal and low-water planting.',
    detectedIntent: 'shrub planting',
    style: 'Shrubs',
    gardenStyles: ['Coastal'],
    plantTypes: ['Shrub'],
    styleTags: ['Coastal'],
    roleTags: ['Flowering Colour', 'Feature Plant'],
    conditions: {
  ...
  {
    name: 'Libertia',
    description: 'NZ native strappy clump with iris-like leaves and white flowers.',
    notes: 'Low-care native filler; distinct from Lomandra overlay.',
    detectedIntent: 'general planting',
    style: 'Border planting',
    gardenStyles: ['Native', 'Low maintenance'],
    plantTypes: ['Grass / strappy plant'],
  ...
  {
    name: 'Puka',
    description: 'Large NZ native tree with bold glossy leaves on a clear trunk.',
    notes: 'Updated puka.png — fewer branches, glossier leaves, longer stem; spot mode only.',
    detectedIntent: 'feature tree',
    style: 'Feature tree',
    gardenStyles: ['Native', 'Subtropical'],
    plantTypes: ['Tree'],
    styleTags: ['Native', 'Tropical / Subtropical'],
    roleTags: ['Feature Plant'],
    conditions: {
      sun: ['full sun', 'part shade'],
      moisture: ['average', 'moist'],
  ...
  {
    name: 'Potato Vine',
    description: 'Fast-growing evergreen climber with white or pale blue starry flowers.',
    notes: 'Solanum jasminoides — spot climber overlay (potato-vine.png).',
    detectedIntent: 'climber planting',
    style: 'Climbers',
    gardenStyles: ['Cottage', 'Subtropical'],
    plantTypes: ['Climber'],
  ...
  {
    name: 'Scleranthus',
    description: 'Compact native cushion groundcover forming bright green mounds.',
    notes: 'Low mounded groundcover; scleranthus.png overlay for rock gardens and edges.',
    detectedIntent: 'groundcover planting',
    style: 'Groundcovers',
    gardenStyles: ['Native', 'Low maintenance'],
    plantTypes: ['Groundcover'],
  ...
  {
    name: 'Teucrium',
    description: 'Silver-grey Mediterranean shrub with small blue flowers; clips into a neat hedge.',
    notes: 'Spot: teucrium.png. Row: teucrium-hedge.png via Teucrium Hedge row option.',
    detectedIntent: 'shrub planting',
    style: 'Shrubs',
    gardenStyles: ['Formal', 'Coastal', 'Low maintenance'],
    plantTypes: ['Shrub', 'Hedge / screening'],
    styleTags: ['Formal', 'Coastal', 'Low Maintenance', 'Privacy / Screening'],
    roleTags: ['Hedge / Screen', 'Feature Plant'],
    conditions: {
      sun: ['full sun'],
      moisture: ['average', 'dry'],
...
const SPECIES_RULES: Array<{ pattern: RegExp; assetKey: string }> = [
  ...
  { pattern: /^jasmine$/i,                                             assetKey: 'jasmine' },
  { pattern: /jasminum/i,                                              assetKey: 'jasmine' },
  ...
  { pattern: /grevillea/i,                                             assetKey: 'grevillea' },
  ...
  { pattern: /leptinella|brass buttons/i,                              assetKey: 'leptinella' },
  { pattern: /leucadendron/i,                                          assetKey: 'leucadendron' },
  { pattern: /leucospermum|pincushion protea/i,                        assetKey: 'leucospermum' },
  { pattern: /\blibertia\b/i,                                          assetKey: 'libertia' },
  ...
  { pattern: /potato vine|solanum jasminoides/i,                         assetKey: 'potato-vine' },
  ...
  { pattern: /heuchera|coral bells/i,                                  assetKey: 'heuchera' },
  { pattern: /hosta|plantain lily/i,                                   assetKey: 'hosta' },
  ...
  { pattern: /photinia/i,                                                assetKey: 'photinia-hedge' },
  { pattern: /loropetalum/i,                                             assetKey: 'loropetalum-hedge' },
  { pattern: /teucrium hedge/i,                                          assetKey: 'teucrium-hedge' },
  { pattern: /teucrium/i,                                              assetKey: 'teucrium' },
  { pattern: /puka|meryta sinclairii/i,                                  assetKey: 'puka' },
  { pattern: /scleranthus/i,                                             assetKey: 'scleranthus' },
  ...
  { pattern: /\bcarex\b/i,                                             assetKey: 'carex' },
  { pattern: /choisya|mexican orange/i,                                assetKey: 'choisya' },
  { pattern: /clumping bamboo|fargesia|bambusa|multiplex bamboo/i,     assetKey: 'clumping-bamboo' },
  { pattern: /cordyline/i,                                             assetKey: 'cordyline-stricta' },
  { pattern: /crepe myrtle|crape myrtle|lagerstroemia/i,               assetKey: 'crepe-myrtle' },
  { pattern: /cyclamen/i,                                              assetKey: 'cyclamen' },
  { pattern: /dogwood|cornus florida|cornus/i,                         assetKey: 'dogwood' },
  { pattern: /daphne/i,                                                assetKey: 'daphne' },
  { pattern: /ake.?ake|dodonaea/i,                                     assetKey: 'ake-ake' },
  { pattern: /agapanthus|lily of the nile/i,                           assetKey: 'agapanthus' },
  { pattern: /acorus|sweet flag/i,                                     assetKey: 'acorus' },
  { pattern: /ajuga|bugle/i,                                           assetKey: 'ajuga' },
  { pattern: /alstroemeria|peruvian lily/i,                            assetKey: 'alstroemeria' },
  { pattern: /apodasmia|leptocarpus/i,                               assetKey: 'apodasmia' },
  { pattern: /astilbe/i,                                               assetKey: 'astilbe' },
  { pattern: /\bazalea\b/i,                                            assetKey: 'azalea' },
...
const ROW_PREVIEW_HEDGE_ENTRIES: Array<{ name: string; detectedIntent: string }> = [
  ...
  { name: 'Photinia Hedge', detectedIntent: 'hedge/screening' },
...
export const SPOT_HEDGE_OVERLAY_PAIRS: ReadonlyArray<{
  ...
  { label: 'Teucrium', spotFile: 'teucrium.png', hedgeFile: 'teucrium-hedge.png' },
]
