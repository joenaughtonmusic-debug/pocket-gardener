...
export const PLANT_COVERAGE_OVERRIDES: Record<number, PlantCoverageOverride> = {
  ...
  61: {
    classification: 'exact_asset_ready',
    priority: 'launch',
    notes: 'Dedicated pohutukawa.png overlay — spot mode only.',
  },
  ...
  13: {
    classification: 'exact_asset_ready',
    priority: 'launch',
    notes: 'Dedicated pink-rhaphiolepis.png overlay — spot mode only.',
  },
  ...
  63: {
    classification: 'exact_asset_ready',
    priority: 'launch',
    notes: 'Dedicated olive-tree.png overlay — spot mode only.',
  },
  ...
  111: {
    ...
    priority: 'launch',
    paleFlowerRisk: true,
    notes: 'Dedicated rain-lily.png overlay — cream/soft-white flowers via luminance-preserving recolour; spot mode only.',
  },
  ...
  70: {
    ...
    priority: 'launch',
    paleFlowerRisk: true,
    notes: 'Dedicated peach-tree.png overlay — spot mode only.',
  },
...
export const PRIMARY_EXACT_ASSET_PATTERNS: Array<{ pattern: RegExp; assetKey: string }> = [
  ...
  { pattern: /buxus hedge|japanese box|\bbox hedge\b/i, assetKey: 'buxus-hedge' },
  ...
  { pattern: /^agapanthus$/i, assetKey: 'agapanthus' },
  ...
  { pattern: /^buxus ball$/i, assetKey: 'buxus-ball' },
  ...
  { pattern: /^olive tree$/i, assetKey: 'olive-tree' },
  { pattern: /^orange trumpet vine$/i, assetKey: 'orange-trumpet-vine' },
  { pattern: /^peach tree$/i, assetKey: 'peach-tree' },
  { pattern: /^pink rhaphiolepis$/i, assetKey: 'pink-rhaphiolepis' },
  { pattern: /^photinia hedge$/i, assetKey: 'photinia-hedge' },
  { pattern: /^loropetalum hedge$/i, assetKey: 'loropetalum-hedge' },
  { pattern: /^pittosporum$/i, assetKey: 'pittosporum' },
  { pattern: /^puka$/i, assetKey: 'puka' },
  { pattern: /^pohutukawa$/i, assetKey: 'pohutukawa' },
  { pattern: /^potato vine$/i, assetKey: 'potato-vine' },
